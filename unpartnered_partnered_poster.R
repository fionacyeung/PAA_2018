...
paired1996 = data1996[idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
paired1996$pair_id = rep(1:(nrow(paired1996)/2), each=2)
single1996 = data1996[-idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
...
paired2001 = data2001[idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
paired2001$pair_id = rep(1:(nrow(paired2001)/2), each=2)
single2001 = data2001[-idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
...
paired2004 = data2004[idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
paired2004$pair_id = rep(1:(nrow(paired2004)/2), each=2)
single2004 = data2004[-idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
...
paired2008 = data2008[idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
paired2008$pair_id = rep(1:(nrow(paired2008)/2), each=2)
single2008 = data2008[-idx,c("pid", "spanel_all", "wpfinwgt_t", "tage_t", "female_t", "race_t", "educlevel_t", "allrespartid_w", "newrelunpar" )]
